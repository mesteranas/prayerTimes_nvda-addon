...
class Client:
    ...
    def get_today_times(self, location: Union[Coordinates, Address, City] = None):
        """
    ...
    def get_annual_times(self, location: Union[Coordinates, Address, City] = None, year: int=None):
        """
